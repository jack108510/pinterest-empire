...
SESSION = os.path.expanduser('~/.pinterest-session-cooking')
...
TITLES = [
    "This 5-ingredient dinner changed my life 🍳",
    "15-minute meal that tastes like it took hours 🕐",
    "The kitchen hack nobody tells you about 💡",
    "Meal prep Sunday done in 30 minutes 🥗",
    "This dessert has 3 ingredients and zero guilt 🍰",
    "Restaurant-quality dinner for under $10 💰",
    "I tried the viral recipe and here's what happened 🤯",
    "The one pan trick that saves hours of cleanup ✨",
    "Breakfast prep that lasts all week 🥞",
    "Secret ingredient that makes everything better 🧄",
    "My grandmother's recipe gone viral 👵",
    "The air fryer recipe everyone's obsessed with 🔥",
    "Healthy swaps that actually taste good 🥑",
    "Dinner ideas for people who hate cooking 😅",
    "The sauce that goes with literally everything 🫕",
]
